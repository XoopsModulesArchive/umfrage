...
define('_MD_CAN_ACCESS', "您<strong><span style=\"color: green; \">可以</span></strong>访问该板.<br>");
define('_MD_CANNOT_ACCESS', '您<strong>不可</strong>访问该板.<br>');
define('_MD_CAN_POST', "您<strong><span style=\"color: green; \">可以</span></strong>发帖.<br>");
define('_MD_CANNOT_POST', "您<strong><span style=\"color: red; \">不可</span></strong>发帖.<br>");
define('_MD_CAN_VIEW', "您<strong><span style=\"color: green; \">可以</span></strong>查看帖子.<br>");
define('_MD_CANNOT_VIEW', "您<strong><span style=\"color: red; \">不可</span></strong>查看帖子.<br>");
define('_MD_CAN_REPLY', "您<strong><span style=\"color: green; \">可以</span></strong>回复.<br>");
define('_MD_CANNOT_REPLY', "您<strong><span style=\"color: red; \">不可</span></strong>回复.<br>");
define('_MD_CAN_EDIT', "您<strong><span style=\"color: green; \">可以</span></strong>编辑自己的帖子.<br>");
define('_MD_CANNOT_EDIT', "您<strong><span style=\"color: red; \">不可</span></strong>编辑自己的帖子.<br>");
define('_MD_CAN_DELETE', "您<strong><span style=\"color: green; \">可以</span></strong>删除自己的帖子.<br>");
define('_MD_CANNOT_DELETE', "您<strong><span style=\"color: red; \">不可</span></strong>删除自己的帖子.<br>");
define('_MD_CAN_ADDPOLL', "您<strong><span style=\"color: green; \">可以</span></strong>发起投票调查.<br>");
define('_MD_CANNOT_ADDPOLL', "您<strong><span style=\"color: red; \">不可</span></strong>发起投票调查.<br>");
define('_MD_CAN_VOTE', "您<strong><span style=\"color: green; \">可以</span></strong>在投票调查中投票.<br>");
define('_MD_CANNOT_VOTE', "您<strong><span style=\"color: red; \">不可</span></strong>在投票调查中投票.<br>");
define('_MD_CAN_ATTACH', "您<strong><span style=\"color: green; \">可以</span></strong>上传附件.<br>");
define('_MD_CANNOT_ATTACH', "您<strong><span style=\"color: red; \">不可</span></strong>上传附件.<br>");
define('_MD_CAN_NOAPPROVE', "您<strong><span style=\"color: green; \">可以</span></strong>不经审核直接发帖.<br>");
define('_MD_CANNOT_NOAPPROVE', "您<strong><span style=\"color: red; \">不可</span></strong>不经审核直接发帖.<br>");
...
class User_language extends \User
{
    ...
    public function getUserbar()
    {
        ...
        if ($user->getVar('user_icq')) {
            $userbar[] = ['link' => "javascript:void window.open('http://friend.qq.com/cgi-bin/friend/user_show_info?ln=" . $user->getVar('user_icq') . "','new');", 'name' => _MD_ICQ];
        }
