...
define("_AM_MULTI_LIMIT","How many options can the voter choose?");
define("_AM_MULTI_LIMIT_HELP","This is only needed if you allow multiple selection. Leave empty for no limit.");
define("_AM_NOTIFY","Notify the poll author when expired?");
define("_AM_NOTIFY_VOTER","Notify the user on voting?");
...
define('_AM_AUTOBLOCKREMOVE','Remove from Block at end of poll');
define('_AM_POLLTYPE','Polltype');
